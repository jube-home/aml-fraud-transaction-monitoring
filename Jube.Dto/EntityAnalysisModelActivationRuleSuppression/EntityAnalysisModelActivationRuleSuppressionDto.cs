...
namespace Jube.Dto.EntityAnalysisModelActivationRuleSuppression
{
    [FormEndpoint("EntityAnalysisModelActivationRuleSuppression")]
    ...
    public class EntityAnalysisModelActivationRuleSuppressionDto : IUpdated
    {
        ...
        [Description("Name of the Activation Rule this Suppression is scoped to, within the Model given by " +
        ...
        [Description("Wire-compatibility field carried from the legacy DTO. The presence of a (non-deleted, " +
                     ...
                     "EntityAnalysisModelActivationRuleName IS the suppression state -- this flag has no backing " +
