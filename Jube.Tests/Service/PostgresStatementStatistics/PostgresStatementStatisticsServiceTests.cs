...
namespace Jube.Test.Service.PostgresStatementStatistics
{
    ...
    [Collection("Database")]
    public sealed class PostgresStatementStatisticsServiceTests(DatabaseFixture fx)
    {
        ...
        private static Task<PostgresStatementStatisticsService> BuildServiceAsync(
            DbContext dbContext, string? userName, ILog? log = null, ILog? auditLog = null,
            IServiceChangeBus? serviceChangeBus = null)
        {
            return PostgresStatementStatisticsService.CreateAsync(
        ...
        public async Task ListIsNotTenantScopedAsync()
        {
            ...
            resultA.Total.Should().Be(resultB.Total);
        }
        ...
        public async Task ListSortsByCallsAscendingAndDescendingAsync()
        {
            ...
            var descending = await service.ListAsync(sortField: "calls", sortDirection: "desc");
            descending.Rows.Select(r => r.Calls).Should().BeInDescendingOrder();
        }
        ...
        public async Task ListStatisticsIncludesEveryContinuousMeasuredColumnAsync()
        {
            ...
            result.Statistics.Columns.Keys.Should().BeEquivalentTo(
                "calls", "rows", "totalExecTimeMilliseconds", "meanExecTimeMilliseconds",
                "minExecTimeMilliseconds", "maxExecTimeMilliseconds", "stddevExecTimeMilliseconds",
                "sharedBlksHitBytes", "sharedBlksReadBytes", "tempBlksReadBytes", "tempBlksWrittenBytes",
                "walBytes");
        }
    }
}