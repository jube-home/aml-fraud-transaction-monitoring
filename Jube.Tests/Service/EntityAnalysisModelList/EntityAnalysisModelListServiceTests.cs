...
namespace Jube.Test.Service.EntityAnalysisModelList
{
    using EntityAnalysisModelListService = EntityAnalysisModelListService;

    [Trait("Category", "Service")]
    [Collection("Database")]
    public sealed class EntityAnalysisModelListServiceTests(DatabaseFixture fx) : IAsyncLifetime
    {
        ...
        public async Task DisposeAsync()
        {
            ...
            foreach (var id in createdIds)
            {
                await dbContext.GetTable<EntityAnalysisModelListVersion>()
                    .Where(w => w.EntityAnalysisModelListId == id).DeleteAsync();
                await dbContext.GetTable<Data.Poco.EntityAnalysisModelList>().Where(w => w.Id == id).DeleteAsync();
            }
        ...
        private static Task<EntityAnalysisModelListService> BuildServiceAsync(
            DbContext dbContext, string? userName, ILog? log = null, ILog? auditLog = null,
            IServiceChangeBus? serviceChangeBus = null)
        {
            return EntityAnalysisModelListService.CreateAsync(
        ...
        private static EntityAnalysisModelListDto NewDto(Guid entityAnalysisModelGuid, string name)
        {
            return new EntityAnalysisModelListDto
            {
        ...
        public async Task UpdateIncrementsVersionAndWritesAuditRowAsync()
        {
            ...
            var auditRows = await dbContext.GetTable<EntityAnalysisModelListVersion>()
                .Where(w => w.EntityAnalysisModelListId == saved.Id).CountAsync();
        ...
        public async Task EveryMethodThrowsForbiddenWhenPermissionMissingAndWritesNoRowAsync()
        {
            ...
            var beforeCount = await dbContext.GetTable<Data.Poco.EntityAnalysisModelList>()
            ...
            var afterCount = await dbContext.GetTable<Data.Poco.EntityAnalysisModelList>()
                .CountAsync(w => w.Name!.StartsWith(DatabaseFixture.Prefix));
        ...
        public async Task NullOrBlankUserNameThrowsNotAuthenticatedBeforeAnyQueryAsync(string? userName)
        {
            ...
            var ex = await Assert.ThrowsAsync<NotAuthenticatedException>(() =>
                EntityAnalysisModelListService.CreateAsync(dbContext, userName, log, localizers,
        ...
        public async Task NameRequiredRejectsNullEmptyOrWhitespaceAsync(string? name)
        {
            ...
            ex.Result.Errors.Should().Contain(e =>
                e.PropertyName == nameof(EntityAnalysisModelListDto.Name) &&
        ...
        public async Task EachCallEmitsOneSpanWithOutcomeTagAsync()
        {
            ...
            var createSpan = activities.Should()
                .ContainSingle(a => a.OperationName == "EntityAnalysisModelList.Create").Subject;
        ...
        public async Task ReadsAndFailuresPublishNothingAsync()
        {
            ...
            await Assert.ThrowsAsync<DtoValidationException>(() =>
                service.InsertAsync(NewDto(model.Guid, "")));
        ...
        public void CatalogueRegistersUniquePascalCaseNoUnderscoreNames()
        {
            ...
            [
                "EntityAnalysisModelListList", "EntityAnalysisModelListGet",
                "EntityAnalysisModelListGetByEntityAnalysisModelId",
                "EntityAnalysisModelListCreate", "EntityAnalysisModelListUpdate",
                "EntityAnalysisModelListDelete"
            ]);
        }
