...
namespace Jube.Test.Service.Query.ExhaustiveSearchInstancePromotedTrialInstanceRoc.Models
{
    internal sealed class CapturingBus : IServiceChangeBus
    {
        ...
        public IDisposable Subscribe(Func<ServiceChangeEvent, Task> handler) => new Noop();
