...
namespace Jube.Service.EntityAnalysisModelTtlCounter
{
    ...
    public sealed class EntityAnalysisModelTtlCounterService
    {
        ...
        private static readonly int[] listPermissions = [12];
        private static readonly int[] readPermissions = [12];
        private static readonly int[] readByModelPermissions = [12, 17];
        private static readonly int[] writePermissions = [12];
        ...
        public async Task<List<EntityAnalysisModelTtlCounterDto>> GetAsync(CancellationToken token = default)
        {
            ...
            try
            {
                EnsurePermitted(listPermissions, "EntityAnalysisModelTtlCounter.List");
        ...
        [Description("Lists TTL Counters belonging to the given Model, ordered by Id, scoped to the calling " +
                     "user's tenant.")]
            ...
            CancellationToken token = default)
        {
            ...
            try
            {
                EnsurePermitted(readByModelPermissions, "EntityAnalysisModelTtlCounter.ListByEntityAnalysisModelId");
        ...
        [Description("Lists TTL Counters belonging to the Model with the given Guid, scoped to the calling " +
                     "user's tenant. Used to populate the TTL Counter picker on the Activation Rule increment " +
                     "editor.")]
            ...
            CancellationToken token = default)
        {
            ...
            try
            {
                EnsurePermitted(readByModelPermissions,
                    "EntityAnalysisModelTtlCounter.ListByEntityAnalysisModelGuid");
                var dtos = EntityAnalysisModelTtlCounterMapper.ToDto(await repository
            ...
            CancellationToken token = default)
        {
            ...
            try
            {
                EnsurePermitted(readPermissions, "EntityAnalysisModelTtlCounter.Get");
        ...
        [Description("Lists TTL Counters for the caller's tenant, ordered by id, capped at 'take' rows (max 200). " +
            ...
            CancellationToken token = default)
        {
            ...
            try
            {
                EnsurePermitted(listPermissions, "EntityAnalysisModelTtlCounter.ListPaged");
            ...
            CancellationToken token = default)
        {
            ...
            try
            {
                ...
                EnsurePermitted(writePermissions, "EntityAnalysisModelTtlCounter.Create");
            ...
            CancellationToken token = default)
        {
            ...
            {
                ArgumentNullException.ThrowIfNull(model);
                EnsurePermitted(writePermissions, "EntityAnalysisModelTtlCounter.Update");
            ...
            catch (Exception ex)
            {
                op.Error(ex);
                log.Error(
                    $"EntityAnalysisModelTtlCounter.Update: unexpected failure id={model?.Id} user={userName}",
                    ex);
                throw;
            }
        }
        ...
        [Description("Deletes a TTL Counter in the caller's tenant by its Id. Reversible at the data level, but " +
                     "treat as destructive -- the TTL Counter immediately stops being incremented on transaction " +
                     "invocation.")]
            ...
            CancellationToken token = default)
        {
            ...
            try
            {
                EnsurePermitted(writePermissions, "EntityAnalysisModelTtlCounter.Delete");
