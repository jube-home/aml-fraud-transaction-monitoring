...
{
    using QueryDto = global::Jube.Data.Query.GetCaseByCaseKeyValueQuery.Dto;

    internal static class CaseByCaseKeyValueMapper
    {
        public static CaseByCaseKeyValueDto ToDto(QueryDto source) => new()
        {
            Id = source.Id,
            ...
            CaseWorkflowStatusName = source.CaseWorkflowStatusName,
        ...
        public static List<CaseByCaseKeyValueDto> ToDto(IEnumerable<QueryDto> source) =>
