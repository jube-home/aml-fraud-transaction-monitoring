...
namespace Jube.Service.EntityAnalysisModelDictionary
{
    ...
    public sealed class EntityAnalysisModelDictionaryService
    {
        ...
        internal static async Task<EntityAnalysisModelDictionaryService> CreateAsync(DbContext dbContext,
            string? userName, ILog log, IStringLocalizerFactory stringLocalizerFactory,
        ...
        public async Task<List<EntityAnalysisModelDictionaryDto>> GetAsync(CancellationToken token = default)
        {
            ...
            try
            {
                EnsurePermitted("EntityAnalysisModelDictionary.List");
                var dtos = EntityAnalysisModelDictionaryMapper.ToDto(await repository.GetAsync(token)
                    .ConfigureAwait(false));
                op.Rows(dtos.Count);
            ...
            {
                op.Error(ex);
                log.Error($"EntityAnalysisModelDictionary.List: unexpected failure user={userName}", ex);
                throw;
            }
        }

        [Description("Lists the Dictionaries belonging to the given Model, ordered by Id, scoped to the calling " +
                     "user's tenant. Includes both Active and inactive Dictionaries.")]
        [ServiceOperation("EntityAnalysisModelDictionaryGetByEntityAnalysisModelId", OperationKind.Read,
            Idempotent = true)]
        public async Task<List<EntityAnalysisModelDictionaryDto>> GetByEntityAnalysisModelIdAsync(
            ...
            CancellationToken token = default)
        {
            ...
            try
            {
                EnsurePermitted("EntityAnalysisModelDictionary.ListByEntityAnalysisModelId");
                var dtos = EntityAnalysisModelDictionaryMapper.ToDto(await repository
            ...
            catch (Exception ex)
            {
                op.Error(ex);
                log.Error(
                    $"EntityAnalysisModelDictionary.ListByEntityAnalysisModelId: unexpected failure entityAnalysisModelId={entityAnalysisModelId} user={userName}",
                    ex);
                throw;
            }
        }

        [Description("Returns one Dictionary by its numeric identifier, scoped to the calling user's tenant. " +
                     "Returns null when the row does not exist or is not visible to the caller.")]
        [ServiceOperation("EntityAnalysisModelDictionaryGet", OperationKind.Read, Idempotent = true)]
        public async Task<EntityAnalysisModelDictionaryDto?> GetByIdAsync(
            [Description("Numeric identifier of the Dictionary.")]
            int id,
            CancellationToken token = default)
        {
            ...
            try
            {
                EnsurePermitted("EntityAnalysisModelDictionary.Get");
                var dictionary = await repository.GetByIdAsync(id, token).ConfigureAwait(false);
                if (dictionary == null)
                {
                    if (log.IsDebugEnabled)
                        log.Debug(
                ...
                op.Entity(dictionary.Id);
                return EntityAnalysisModelDictionaryMapper.ToDto(dictionary);
            }
            catch (ForbiddenException)
            {
                op.Outcome("forbidden");
            ...
            {
                op.Error(ex);
                log.Error($"EntityAnalysisModelDictionary.Get: unexpected failure id={id} user={userName}", ex);
                throw;
            }
        }

        [Description("Lists Dictionaries for the caller's tenant, ordered by id, capped at 'take' rows (max " +
                     "200). If 'more' is true, call again with 'afterId' set to the last returned Id to continue.")]
        [ServiceOperation("EntityAnalysisModelDictionaryList", OperationKind.Read, Idempotent = true)]
        public async Task<PagedResult<EntityAnalysisModelDictionaryDto>> ListAsync(
            ...
            CancellationToken token = default)
        {
            using var op = OperationScope.Start("EntityAnalysisModelDictionary", "ListPaged", userName,
                tenantRegistryId, auditLog, log, serviceChangeBus);
            ...
            try
            {
                EnsurePermitted("EntityAnalysisModelDictionary.ListPaged");
                ...
                return new PagedResult<EntityAnalysisModelDictionaryDto>(
                    EntityAnalysisModelDictionaryMapper.ToDto(page));
            }
            catch (ForbiddenException)
            {
                op.Outcome("forbidden");
            ...
            {
                op.Error(ex);
                log.Error($"EntityAnalysisModelDictionary.ListPaged: unexpected failure user={userName}", ex);
                throw;
            }
        }
        ...
        public async Task<DictionaryPoco> InsertAsync(
            [Description("The Dictionary to create.")]
            ...
            CancellationToken token = default)
        {
            ...
            try
            {
                ...
                var saved = await repository.InsertAsync(EntityAnalysisModelDictionaryMapper.ToPoco(model), token)
                    .ConfigureAwait(false);
        ...
        [Description("Updates an existing Dictionary in the caller's tenant, identified by its Id. Idempotent " +
                     "-- repeating the same update has no further effect beyond incrementing Version.")]
        [ServiceOperation("EntityAnalysisModelDictionaryUpdate", OperationKind.Write, Idempotent = true)]
        public async Task<DictionaryPoco> UpdateAsync(
            [Description("The Dictionary to update. Id selects the row; identity/tenant/audit fields are " +
            ...
            CancellationToken token = default)
        {
            ...
            {
                ArgumentNullException.ThrowIfNull(model);
                EnsurePermitted("EntityAnalysisModelDictionary.Update");
                ...
                DictionaryPoco saved;
                try
                {
                    saved = await repository.UpdateAsync(EntityAnalysisModelDictionaryMapper.ToPoco(model), token)
                        .ConfigureAwait(false);
                }
            ...
            {
                op.Error(ex);
                log.Error($"EntityAnalysisModelDictionary.Update: unexpected failure id={model?.Id} user={userName}",
                    ex);
                throw;
            }
        }

        [Description("Deletes a Dictionary in the caller's tenant by its Id. Reversible at the data level, but " +
                     "treat as destructive -- the Dictionary immediately stops being available for lookup during " +
                     "model invocation.")]
        [ServiceOperation("EntityAnalysisModelDictionaryDelete", OperationKind.Delete, Idempotent = true,
            Destructive = true)]
        public async Task DeleteAsync(
            [Description("Numeric identifier of the Dictionary to delete.")]
            int id,
            CancellationToken token = default)
        {
            ...
            try
            {
                EnsurePermitted("EntityAnalysisModelDictionary.Delete");
            ...
            {
                op.Error(ex);
                log.Error($"EntityAnalysisModelDictionary.Delete: unexpected failure id={id} user={userName}", ex);
                throw;
            }
        }
