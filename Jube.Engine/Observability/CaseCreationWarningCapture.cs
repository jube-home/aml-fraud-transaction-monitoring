...
{
    public static class CaseCreationWarningCapture
    {
        private const int MaxQueueLength = 20000;

        private static readonly ConcurrentQueue<CaseCreationWarningCaptureRecord> queue = new();
        ...
        public static void Enqueue(CaseCreationWarningCaptureRecord record)
        {
        ...
        public static List<CaseCreationWarningCaptureRecord> DrainAll()
        {
            var drained = new List<CaseCreationWarningCaptureRecord>();
