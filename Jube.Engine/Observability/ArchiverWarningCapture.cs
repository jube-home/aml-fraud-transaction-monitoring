...
{
    public static class ArchiverWarningCapture
    {
        private const int MaxQueueLength = 20000;

        private static readonly ConcurrentQueue<ArchiverWarningCaptureRecord> queue = new();
        ...
        public static void Enqueue(ArchiverWarningCaptureRecord record)
        {
        ...
        public static List<ArchiverWarningCaptureRecord> DrainAll()
        {
            var drained = new List<ArchiverWarningCaptureRecord>();
