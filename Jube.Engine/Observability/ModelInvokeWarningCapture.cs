...
{
    public static class ModelInvokeWarningCapture
    {
        private const int MaxQueueLength = 20000;

        private static readonly ConcurrentQueue<ModelInvokeWarningCaptureRecord> queue = new();
        ...
        public static void Enqueue(ModelInvokeWarningCaptureRecord record)
        {
        ...
        public static List<ModelInvokeWarningCaptureRecord> DrainAll()
        {
            var drained = new List<ModelInvokeWarningCaptureRecord>();
