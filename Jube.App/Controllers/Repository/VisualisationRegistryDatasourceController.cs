    ...
    public class VisualisationRegistryDatasourceController : Controller
    {
            ...
            [FromBody] VisualisationRegistryDatasourceDto model)
        {
            try
            {
                ...
                var visualisationRegistryDatasource =
                    _repository.InsertWithValidationAsync(_mapper.Map<VisualisationRegistryDatasource>(model));
            ...
            [FromBody] VisualisationRegistryDatasourceDto model)
        {
            try
            {
                ...
                if (results.IsValid)
                    return Ok(
                        _repository.UpdateWithValidationAsync(_mapper.Map<VisualisationRegistryDatasource>(model)));
