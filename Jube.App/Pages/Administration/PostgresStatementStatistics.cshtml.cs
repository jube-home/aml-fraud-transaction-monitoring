...
{
    [Authorize]
    public class PostgresStatementStatistics : PageModel
    {
        private readonly PermissionValidation permissionValidation;
        private readonly string userName;

        public PostgresStatementStatistics(ILog log, DynamicEnvironment.DynamicEnvironment dynamicEnvironment,
