...
$(document).ready(function () {
    ...
    $grid.kendoGrid({
        ...
        toolbar: kendo.template(
            ...
            '<label style="display:flex;align-items:center;gap:4px;">Search <input type="text" id="searchBox" placeholder="Channel or message..." /></label>' +
        ...
        columns: [
            ...
            {field: "channel", title: "Channel", width: 160},
    ...
    $exportCsv.on("click", function () {
        exportGridToCsv($grid.data("kendoGrid"), "/api/RedisSentinelEvent", {
            from: $fromDate.data("kendoDateTimePicker").value()?.toISOString() ?? null,
            to: $toDate.data("kendoDateTimePicker").value()?.toISOString() ?? null,
            search: $searchBox.val() || null
        }, "RedisSentinelEvent.csv");
    });

    dataSourceEntity.read();
});

//# sourceURL=RedisSentinelEvent.js
