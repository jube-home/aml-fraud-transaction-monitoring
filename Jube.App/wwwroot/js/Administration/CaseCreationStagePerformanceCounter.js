...
const dataSourceEntity = new kendo.data.DataSource({
    transport: {
        read: {
            url: "/api/CaseCreationStagePerformanceCounter",
            type: "GET",
            dataType: "json",
            data: function () {
...
$(document).ready(function () {
    ...
    $exportCsv.on("click", function () {
        exportGridToCsv($grid.data("kendoGrid"), "/api/CaseCreationStagePerformanceCounter", {
            from: $fromDate.data("kendoDateTimePicker").value()?.toISOString() ?? null,
            to: $toDate.data("kendoDateTimePicker").value()?.toISOString() ?? null,
            stageId: $stageFilter.val() || null
        }, "CaseCreationStagePerformanceCounter.csv");
    });

    dataSourceEntity.read();
});

//# sourceURL=CaseCreationStagePerformanceCounter.js
