...
const endpoint = "/api/OpenTelemetryExclude";
const validationFail = "There is invalid data in the form. Please check fields and correct.";

function getRecords() {
    $("#Excludes").html("");

    $.get("/api/OpenTelemetryExclude",
        function (data) {
            for (const value of data) {
                $("#Excludes").prepend("<a href='#' onclick='loadTemplate(" + value.id + ");'>" + value.name + "</a></br>");
            }
        }
    );
}
...
//# sourceURL=OpenTelemetryExclude.js