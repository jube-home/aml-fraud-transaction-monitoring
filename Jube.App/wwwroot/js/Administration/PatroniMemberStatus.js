    ...
    schema: {
        ...
        model: {
            ...
            fields: {
                ...
                host: {type: "string", editable: false},
                port: {type: "number", editable: false},
                apiUrl: {type: "string", editable: false},
                role: {type: "string", editable: false},
                state: {type: "string", editable: false},
                timelineId: {type: "number", editable: false},
                lagBytes: {type: "number", editable: false},
                pendingRestart: {type: "boolean", editable: false},
                patroniVersion: {type: "string", editable: false},
                scope: {type: "string", editable: false},
                postgresServerVersion: {type: "number", editable: false},
                databaseSystemIdentifier: {type: "string", editable: false},
                xlogLocationBytes: {type: "number", editable: false},
                receivedLocationBytes: {type: "number", editable: false},
                replayPaused: {type: "boolean", editable: false},
                clusterUnlocked: {type: "boolean", editable: false},
                syncStandby: {type: "boolean", editable: false},
...
$(document).ready(function () {
    ...
    $grid.kendoGrid({
        ...
        toolbar: kendo.template(
            ...
            '<label style="display:flex;align-items:center;gap:4px;">Search <input type="text" id="searchBox" placeholder="Name, host, role, state, scope..." /></label>' +
        ...
        columns: [
            ...
            {field: "host", title: "Host", width: 140},
            {field: "port", title: "Port", width: 90},
            {field: "apiUrl", title: "API URL", width: 220},
            {field: "role", title: "Role", width: 110},
            {field: "state", title: "State", width: 130},
            {field: "timelineId", title: "Timeline", width: 100},
            {field: "lagBytes", title: "Lag Bytes", width: 120},
            {field: "pendingRestart", title: "Pending Restart", width: 130},
            {field: "patroniVersion", title: "Patroni Version", width: 130},
            {field: "scope", title: "Scope", width: 120},
            {field: "postgresServerVersion", title: "Postgres Server Version", width: 180},
            {field: "databaseSystemIdentifier", title: "Database System Identifier", width: 200},
            {field: "xlogLocationBytes", title: "Xlog Location Bytes", width: 170},
            {field: "receivedLocationBytes", title: "Received Location Bytes", width: 190},
            {field: "replayPaused", title: "Replay Paused", width: 130},
            {field: "clusterUnlocked", title: "Cluster Unlocked", width: 140},
            {field: "syncStandby", title: "Sync Standby", width: 120},
    ...
    $exportCsv.on("click", function () {
        exportGridToCsv($grid.data("kendoGrid"), "/api/PatroniMemberStatus", {
            from: $fromDate.data("kendoDateTimePicker").value()?.toISOString() ?? null,
            to: $toDate.data("kendoDateTimePicker").value()?.toISOString() ?? null,
            search: $searchBox.val() || null
        }, "PatroniMemberStatus.csv");
    });

    dataSourceEntity.read();
});

//# sourceURL=PatroniMemberStatus.js
