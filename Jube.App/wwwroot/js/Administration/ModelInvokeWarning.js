    ...
    schema: {
        ...
        model: {
            ...
            fields: {
                ...
                sinceLastEntryMicroseconds: {type: "number", editable: false},
                elapsedMicroseconds: {type: "number", editable: false},
                threadId: {type: "number", editable: false},
...
$(document).ready(function () {
    ...
    $grid.kendoGrid({
        ...
        toolbar: kendo.template(
            ...
            '<label style="display:flex;align-items:center;gap:4px;">Search <input type="text" id="searchBox" placeholder="Model or message..." /></label>' +
        ...
        columns: [
            ...
            {field: "entityAnalysisModelName", title: "Model", width: 200},
            {field: "message", title: "Message"},
            {field: "sinceLastEntryMicroseconds", title: "Gap (µs)", width: 120},
            {field: "elapsedMicroseconds", title: "Elapsed (µs)", width: 130},
            {field: "threadId", title: "Thread", width: 90},
    ...
    $exportCsv.on("click", function () {
        exportGridToCsv($grid.data("kendoGrid"), "/api/ModelInvokeWarning", {
            from: $fromDate.data("kendoDateTimePicker").value()?.toISOString() ?? null,
            to: $toDate.data("kendoDateTimePicker").value()?.toISOString() ?? null,
            search: $searchBox.val() || null
        }, "ModelInvokeWarning.csv");
    });

    dataSourceEntity.read();
});

//# sourceURL=ModelInvokeWarning.js
