...
const dataSourceEntity = new kendo.data.DataSource({
    transport: {
        read: {
            url: "/api/ArchiverStagePerformanceCounter",
            type: "GET",
            dataType: "json",
            data: function () {
...
$(document).ready(function () {
    ...
    $exportCsv.on("click", function () {
        exportGridToCsv($grid.data("kendoGrid"), "/api/ArchiverStagePerformanceCounter", {
            from: $fromDate.data("kendoDateTimePicker").value()?.toISOString() ?? null,
            to: $toDate.data("kendoDateTimePicker").value()?.toISOString() ?? null,
            stageId: $stageFilter.val() || null
        }, "ArchiverStagePerformanceCounter.csv");
    });

    dataSourceEntity.read();
});

//# sourceURL=ArchiverStagePerformanceCounter.js
