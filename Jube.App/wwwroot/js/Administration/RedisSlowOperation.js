    ...
    schema: {
        ...
        model: {
            ...
            fields: {
                ...
                commandName: {type: "string", editable: false},
                keyName: {type: "string", editable: false},
...
$(document).ready(function () {
    ...
    $grid.kendoGrid({
        ...
        toolbar: kendo.template(
            ...
            '<label style="display:flex;align-items:center;gap:4px;">Search <input type="text" id="searchBox" placeholder="Command, client address or name..." /></label>' +
        ...
        columns: [
            ...
            {field: "durationMicroseconds", title: "Duration Microseconds", width: 160},
            {field: "command", title: "Command"},
            {field: "clientAddress", title: "Client Address", width: 180},
    ...
    $exportCsv.on("click", function () {
        exportGridToCsv($grid.data("kendoGrid"), "/api/RedisSlowOperation", {
            from: $fromDate.data("kendoDateTimePicker").value()?.toISOString() ?? null,
            to: $toDate.data("kendoDateTimePicker").value()?.toISOString() ?? null,
            search: $searchBox.val() || null
        }, "RedisSlowOperation.csv");
    });

    dataSourceEntity.read();
});

//# sourceURL=RedisSlowOperation.js
