    ...
    schema: {
        ...
        model: {
            ...
            fields: {
                ...
                actorId: {type: "string", editable: false},
                actorName: {type: "string", editable: false},
...
$(document).ready(function () {
    ...
    $grid.kendoGrid({
        ...
        toolbar: kendo.template(
            ...
            '<label style="display:flex;align-items:center;gap:4px;">Search <input type="text" id="searchBox" placeholder="Type, action or actor..." /></label>' +
        ...
        columns: [
            ...
            {field: "eventType", title: "Type", width: 100},
            {field: "action", title: "Action"},
            {field: "actorName", title: "Actor", width: 200},
            {field: "actorId", title: "Actor Id", width: 140},
            {field: "scope", title: "Scope", width: 90},
    ...
    $exportCsv.on("click", function () {
        exportGridToCsv($grid.data("kendoGrid"), "/api/DockerEvent", {
            from: $fromDate.data("kendoDateTimePicker").value()?.toISOString() ?? null,
            to: $toDate.data("kendoDateTimePicker").value()?.toISOString() ?? null,
            search: $searchBox.val() || null
        }, "DockerEvent.csv");
