...
{
    public static class EntityAnalysisModelAbstractionCalculationEndpoints
    {
        private const string Base = "/api/EntityAnalysisModelAbstractionCalculation";

        public static void MapEntityAnalysisModelAbstractionCalculationEndpoints(this IEndpointRouteBuilder endpoints)
        {
            var group = endpoints.MapGroup(Base)
                .RequireAuthorization()
                .WithTags("EntityAnalysisModelAbstractionCalculation");

            group.MapGet("", GetAsync)
                .Produces<List<EntityAnalysisModelAbstractionCalculationDto>>()
                .WithName("EntityAnalysisModelAbstractionCalculationGetAll");

            group.MapGet("ByEntityAnalysisModelId/{entityAnalysisModelId:int}", GetByEntityAnalysisModelIdAsync)
                .Produces<List<EntityAnalysisModelAbstractionCalculationDto>>()
                .WithName("EntityAnalysisModelAbstractionCalculationGetByEntityAnalysisModelId");

            group.MapGet("{id:int}", GetByIdAsync)
                .Produces<EntityAnalysisModelAbstractionCalculationDto>()
                .WithName("EntityAnalysisModelAbstractionCalculationGetById");

            group.MapPost("", CreateAsync)
                .Produces((int)HttpStatusCode.OK)
                .Produces<ValidationResult>((int)HttpStatusCode.BadRequest)
                .WithName("EntityAnalysisModelAbstractionCalculationCreate");

            group.MapPut("", UpdateAsync)
                .Produces((int)HttpStatusCode.OK)
                .Produces<ValidationResult>((int)HttpStatusCode.BadRequest)
                .Produces((int)HttpStatusCode.NoContent)
                .WithName("EntityAnalysisModelAbstractionCalculationUpdate");

            group.MapDelete("{id:int}", DeleteAsync)
                .Produces((int)HttpStatusCode.OK)
                .Produces((int)HttpStatusCode.NoContent)
                .WithName("EntityAnalysisModelAbstractionCalculationDelete");
        }
            ...
            CancellationToken token)
        {
            ...
            try
            {
                var service = await EntityAnalysisModelAbstractionCalculationService.CreateAsync(dbContext, user, log,
        ...
        private static async Task<IResult> CreateAsync(
            [FromBody] EntityAnalysisModelAbstractionCalculationDto model, HttpContext httpContext, ILog log,
