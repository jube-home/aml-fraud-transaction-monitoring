...
{
    public static class EntityAnalysisModelGatewayRuleEndpoints
    {
        private const string Base = "/api/EntityAnalysisModelGatewayRule";

        public static void MapEntityAnalysisModelGatewayRuleEndpoints(this IEndpointRouteBuilder endpoints)
        {
            var group = endpoints.MapGroup(Base)
                .RequireAuthorization()
                .WithTags("EntityAnalysisModelGatewayRule");

            group.MapGet("", GetAsync)
                .Produces<List<EntityAnalysisModelGatewayRuleDto>>()
                .WithName("EntityAnalysisModelGatewayRuleGetAll");

            group.MapGet("ByEntityAnalysisModelId/{entityAnalysisModelId:int}", GetByEntityAnalysisModelIdAsync)
                .Produces<List<EntityAnalysisModelGatewayRuleDto>>()
                .WithName("EntityAnalysisModelGatewayRuleGetByEntityAnalysisModelId");

            group.MapGet("{id:int}", GetByIdAsync)
                .Produces<EntityAnalysisModelGatewayRuleDto>()
                .WithName("EntityAnalysisModelGatewayRuleGetById");

            group.MapPost("", CreateAsync)
                .Produces((int)HttpStatusCode.OK)
                .Produces<ValidationResult>((int)HttpStatusCode.BadRequest)
                .WithName("EntityAnalysisModelGatewayRuleCreate");

            group.MapPut("", UpdateAsync)
                .Produces((int)HttpStatusCode.OK)
                .Produces<ValidationResult>((int)HttpStatusCode.BadRequest)
                .Produces((int)HttpStatusCode.NoContent)
                .WithName("EntityAnalysisModelGatewayRuleUpdate");

            group.MapDelete("{id:int}", DeleteAsync)
                .Produces((int)HttpStatusCode.OK)
                .Produces((int)HttpStatusCode.NoContent)
                .WithName("EntityAnalysisModelGatewayRuleDelete");

            group.MapPost("{id:int}/Reset", ResetCounterAsync)
                .Produces((int)HttpStatusCode.OK)
                .Produces((int)HttpStatusCode.NoContent)
                .WithName("EntityAnalysisModelGatewayRuleResetCounter");
        }
            ...
            CancellationToken token)
        {
            ...
            try
            {
                var service = await EntityAnalysisModelGatewayRuleService.CreateAsync(dbContext, user, log,
        ...
        private static async Task<IResult> CreateAsync(
            [FromBody] EntityAnalysisModelGatewayRuleDto model, HttpContext httpContext, ILog log,
