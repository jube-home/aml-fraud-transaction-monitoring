...
{
    public static class DotNetRuntimeMetricEndpoints
    {
        private const string Base = "/api/DotNetRuntimeMetric";

        public static void MapDotNetRuntimeMetricEndpoints(this IEndpointRouteBuilder endpoints)
        {
            var group = endpoints.MapGroup(Base)
                .RequireAuthorization()
                .WithTags("DotNetRuntimeMetric");

            group.MapGet("", GetAsync)
                .Produces<PayloadResult<DotNetRuntimeMetricDto>>()
                .WithName("DotNetRuntimeMetricGetAll");
        }
            ...
            CancellationToken token)
        {
            ...
            try
            {
                var service = await DotNetRuntimeMetricService.CreateAsync(dbContext, user, log,
