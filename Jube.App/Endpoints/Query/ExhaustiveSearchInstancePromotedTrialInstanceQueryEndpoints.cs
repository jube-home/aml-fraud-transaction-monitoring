...
{
    public static class ExhaustiveSearchInstancePromotedTrialInstanceQueryEndpoints
    {
        private const string Base = "/api/GetExhaustiveSearchInstancePromotedTrialInstanceQuery";

        public static void MapExhaustiveSearchInstancePromotedTrialInstanceQueryEndpoints(
            this IEndpointRouteBuilder endpoints)
        {
            var group = endpoints.MapGroup(Base)
                .RequireAuthorization()
                .WithTags("ExhaustiveSearchInstancePromotedTrialInstanceQuery");

            group.MapGet("{id:int}", GetAsync)
                .Produces<List<ExhaustiveSearchInstancePromotedTrialInstanceQueryDto>>()
                .WithName("ExhaustiveSearchInstancePromotedTrialInstanceQueryGet");
        }
            ...
            IServiceChangeBus serviceChangeBus, CancellationToken token)
        {
            ...
            try
            {
                var service = await ExhaustiveSearchInstancePromotedTrialInstanceQueryService.CreateAsync(dbContext,
                    user, log,
