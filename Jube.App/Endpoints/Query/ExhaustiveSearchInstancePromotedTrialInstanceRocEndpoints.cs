...
{
    public static class ExhaustiveSearchInstancePromotedTrialInstanceRocEndpoints
    {
        private const string Base = "/api/GetExhaustiveSearchInstancePromotedTrialInstanceRoc";

        public static void MapExhaustiveSearchInstancePromotedTrialInstanceRocEndpoints(
            this IEndpointRouteBuilder endpoints)
        {
            var group = endpoints.MapGroup(Base)
                .RequireAuthorization()
                .WithTags("ExhaustiveSearchInstancePromotedTrialInstanceRoc");

            group.MapGet("{id:int}", GetAsync)
                .Produces<List<ExhaustiveSearchInstancePromotedTrialInstanceRocDto>>()
                .WithName("ExhaustiveSearchInstancePromotedTrialInstanceRocGet");
        }
            ...
            IServiceChangeBus serviceChangeBus, CancellationToken token)
        {
            ...
            try
            {
                var service = await ExhaustiveSearchInstancePromotedTrialInstanceRocService.CreateAsync(dbContext, user,
                    log,
