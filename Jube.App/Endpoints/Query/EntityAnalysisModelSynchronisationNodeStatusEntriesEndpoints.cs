...
{
    public static class EntityAnalysisModelSynchronisationNodeStatusEntriesEndpoints
    {
        private const string Base = "/api/GetEntityAnalysisModelSynchronisationNodeStatusEntries";

        public static void MapEntityAnalysisModelSynchronisationNodeStatusEntriesEndpoints(
            this IEndpointRouteBuilder endpoints)
        {
            var group = endpoints.MapGroup(Base)
                .RequireAuthorization()
                .WithTags("EntityAnalysisModelSynchronisationNodeStatusEntries");

            group.MapGet("", GetAsync)
                .Produces<List<EntityAnalysisModelSynchronisationNodeStatusEntriesDto>>()
                .Produces((int)HttpStatusCode.NoContent)
                .WithName("EntityAnalysisModelSynchronisationNodeStatusEntriesGet");
        }
            ...
            IServiceChangeBus serviceChangeBus, CancellationToken token)
        {
            ...
            try
            {
                var service = await EntityAnalysisModelSynchronisationNodeStatusEntriesService.CreateAsync(dbContext,
