...
{
    public static class ExhaustiveSearchInstanceVariableEndpoints
    {
        private const string Base = "/api/GetExhaustiveSearchInstanceVariableQuery";

        public static void MapExhaustiveSearchInstanceVariableEndpoints(
            this IEndpointRouteBuilder endpoints)
        {
            var group = endpoints.MapGroup(Base)
                .RequireAuthorization()
                .WithTags("ExhaustiveSearchInstanceVariable");

            group.MapGet("{id:int}", GetAsync)
                .Produces<List<ExhaustiveSearchInstanceVariableDto>>()
                .WithName("ExhaustiveSearchInstanceVariableGet");
        }
            ...
            IServiceChangeBus serviceChangeBus, CancellationToken token)
        {
            ...
            try
            {
                var service = await ExhaustiveSearchInstanceVariableService
