...
{
    public static class ExhaustiveSearchInstancePromotedTrialInstanceLearningCurveEndpoints
    {
        private const string Base = "/api/GetExhaustiveSearchInstancePromotedTrialInstanceLearningCurveQuery";

        public static void MapExhaustiveSearchInstancePromotedTrialInstanceLearningCurveEndpoints(
            this IEndpointRouteBuilder endpoints)
        {
            var group = endpoints.MapGroup(Base)
                .RequireAuthorization()
                .WithTags("ExhaustiveSearchInstancePromotedTrialInstanceLearningCurve");

            group.MapGet("{id:int}", GetAsync)
                .Produces<List<ExhaustiveSearchInstancePromotedTrialInstanceLearningCurveDto>>()
                .WithName("ExhaustiveSearchInstancePromotedTrialInstanceLearningCurveGet");
        }
            ...
            IServiceChangeBus serviceChangeBus, CancellationToken token)
        {
            ...
            try
            {
                var service = await ExhaustiveSearchInstancePromotedTrialInstanceLearningCurveService.CreateAsync(
                    dbContext, user, log,
