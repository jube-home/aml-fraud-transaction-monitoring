...
{
    public static class ExhaustiveSearchInstancePromotedTrialInstanceErrorHistogramEndpoints
    {
        private const string Base = "/api/GetExhaustiveSearchInstancePromotedTrialInstanceErrorHistogram";

        public static void MapExhaustiveSearchInstancePromotedTrialInstanceErrorHistogramEndpoints(
            this IEndpointRouteBuilder endpoints)
        {
            var group = endpoints.MapGroup(Base)
                .RequireAuthorization()
                .WithTags("ExhaustiveSearchInstancePromotedTrialInstanceErrorHistogram");

            group.MapGet("{id:int}", GetAsync)
                .Produces<List<ExhaustiveSearchInstancePromotedTrialInstanceErrorHistogramDto>>()
                .WithName("ExhaustiveSearchInstancePromotedTrialInstanceErrorHistogramGet");
        }
            ...
            IServiceChangeBus serviceChangeBus, CancellationToken token)
        {
            ...
            try
            {
                var service = await ExhaustiveSearchInstancePromotedTrialInstanceErrorHistogramService.CreateAsync(
                    dbContext, user, log,
