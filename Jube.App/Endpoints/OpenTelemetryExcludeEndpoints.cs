...
{
    public static class OpenTelemetryExcludeEndpoints
    {
        private const string Base = "/api/OpenTelemetryExclude";

        public static void MapOpenTelemetryExcludeEndpoints(this IEndpointRouteBuilder endpoints)
        {
            var group = endpoints.MapGroup(Base)
                .RequireAuthorization()
                .WithTags("OpenTelemetryExclude");

            group.MapGet("", GetAsync)
                .Produces<List<OpenTelemetryExcludeDto>>()
                .WithName("OpenTelemetryExcludeGetAll");

            group.MapGet("{id:int}", GetByIdAsync)
                .Produces<OpenTelemetryExcludeDto>()
                .WithName("OpenTelemetryExcludeGetById");

            group.MapPost("", CreateAsync)
                .Produces((int)HttpStatusCode.OK)
                .Produces<ValidationResult>((int)HttpStatusCode.BadRequest)
                .WithName("OpenTelemetryExcludeCreate");
            ...
            group.MapPut("", UpdateAsync)
                ...
                .WithName("OpenTelemetryExcludeUpdate");

            group.MapDelete("{id:int}", DeleteAsync)
                .Produces((int)HttpStatusCode.OK)
                .Produces((int)HttpStatusCode.NoContent)
                .Produces((int)HttpStatusCode.Conflict)
                .WithName("OpenTelemetryExcludeDelete");
        }
            ...
            CancellationToken token)
        {
            ...
            try
            {
                var service = await OpenTelemetryExcludeService.CreateAsync(dbContext, user, log,
        ...
        private static async Task<IResult> CreateAsync(
            [FromBody] OpenTelemetryExcludeDto model, HttpContext httpContext, ILog log,
