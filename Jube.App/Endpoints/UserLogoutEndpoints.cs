...
{
    public static class UserLogoutEndpoints
    {
        private const string Base = "/api/UserLogout";

        public static void MapUserLogoutEndpoints(this IEndpointRouteBuilder endpoints)
        {
            ...
            group.MapGet("", GetAsync)
                .Produces<PayloadResult<UserLogoutDto>>()
                .WithName("UserLogoutGetAll");
        }
            ...
            CancellationToken token)
        {
            ...
            try
            {
                var service = await UserLogoutService.CreateAsync(dbContext, user, log,
