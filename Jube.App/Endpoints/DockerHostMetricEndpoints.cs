...
{
    public static class DockerHostMetricEndpoints
    {
        private const string Base = "/api/DockerHostMetric";

        public static void MapDockerHostMetricEndpoints(this IEndpointRouteBuilder endpoints)
        {
            var group = endpoints.MapGroup(Base)
                .RequireAuthorization()
                .WithTags("DockerHostMetric");

            group.MapGet("", GetAsync)
                .Produces<PayloadResult<DockerHostMetricDto>>()
                .WithName("DockerHostMetricGetAll");
        }
            ...
            CancellationToken token)
        {
            ...
            try
            {
                var service = await DockerHostMetricService.CreateAsync(dbContext, user, log,
