...
{
    public static class EntityAnalysisModelProcessingCounterEndpoints
    {
        private const string Base = "/api/EntityAnalysisModelProcessingCounter";

        public static void MapEntityAnalysisModelProcessingCounterEndpoints(this IEndpointRouteBuilder endpoints)
        {
            var group = endpoints.MapGroup(Base)
                .RequireAuthorization()
                .WithTags("EntityAnalysisModelProcessingCounter");

            group.MapGet("", GetAsync)
                .Produces<PayloadResult<EntityAnalysisModelProcessingCounterDto>>()
                .WithName("EntityAnalysisModelProcessingCounterGetAll");
        }
            ...
            IServiceChangeBus serviceChangeBus, CancellationToken token)
        {
            ...
            try
            {
                var service = await EntityAnalysisModelProcessingCounterService.CreateAsync(dbContext, user, log,
