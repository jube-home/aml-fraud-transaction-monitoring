...
{
    public static class DockerContainerMetricEndpoints
    {
        private const string Base = "/api/DockerContainerMetric";

        public static void MapDockerContainerMetricEndpoints(this IEndpointRouteBuilder endpoints)
        {
            var group = endpoints.MapGroup(Base)
                .RequireAuthorization()
                .WithTags("DockerContainerMetric");

            group.MapGet("", GetAsync)
                .Produces<PayloadResult<DockerContainerMetricDto>>()
                .WithName("DockerContainerMetricGetAll");
        }
            ...
            CancellationToken token)
        {
            ...
            try
            {
                var service = await DockerContainerMetricService.CreateAsync(dbContext, user, log,
