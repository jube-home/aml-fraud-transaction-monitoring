...
{
    public static class RedisConnectionMultiplexerMetricEndpoints
    {
        private const string Base = "/api/RedisConnectionMultiplexerMetric";

        public static void MapRedisConnectionMultiplexerMetricEndpoints(this IEndpointRouteBuilder endpoints)
        {
            var group = endpoints.MapGroup(Base)
                .RequireAuthorization()
                .WithTags("RedisConnectionMultiplexerMetric");

            group.MapGet("", GetAsync)
                .Produces<PayloadResult<RedisConnectionMultiplexerMetricDto>>()
                .WithName("RedisConnectionMultiplexerMetricGetAll");
        }
            ...
            CancellationToken token)
        {
            ...
            try
            {
                var service = await RedisConnectionMultiplexerMetricService.CreateAsync(dbContext, user, log,
