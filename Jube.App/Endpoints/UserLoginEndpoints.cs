...
namespace Jube.App.Endpoints
{
    ...
    {
        private const string Base = "/api/UserLogin";
        ...
        public static void MapUserLoginEndpoints(this IEndpointRouteBuilder endpoints)
        {
            ...
            group.MapGet("", GetAsync)
                .Produces<PayloadResult<UserLoginDto>>()
                .WithName("UserLoginGetAll");
        }
            ...
            CancellationToken token)
        {
            ...
            try
            {
                var service = await UserLoginService.CreateAsync(dbContext, user, log,
