...
{
    public static class OverlayNetworkTaskDriftEndpoints
    {
        private const string Base = "/api/OverlayNetworkTaskDrift";

        public static void MapOverlayNetworkTaskDriftEndpoints(this IEndpointRouteBuilder endpoints)
        {
            var group = endpoints.MapGroup(Base)
                .RequireAuthorization()
                .WithTags("OverlayNetworkTaskDrift");

            group.MapGet("", GetAsync)
                .Produces<PayloadResult<OverlayNetworkTaskDriftDto>>()
                .WithName("OverlayNetworkTaskDriftGetAll");
        }
            ...
            CancellationToken token)
        {
            ...
            try
            {
                var service = await OverlayNetworkTaskDriftService.CreateAsync(dbContext, user, log,
