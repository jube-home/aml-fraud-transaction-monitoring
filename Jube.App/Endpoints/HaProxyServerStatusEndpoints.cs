...
{
    public static class HaProxyServerStatusEndpoints
    {
        private const string Base = "/api/HAProxyServerStatus";

        public static void MapHaProxyServerStatusEndpoints(this IEndpointRouteBuilder endpoints)
        {
            var group = endpoints.MapGroup(Base)
                .RequireAuthorization()
                .WithTags("HAProxyServerStatus");

            group.MapGet("", GetAsync)
                .Produces<PayloadResult<HaProxyServerStatusDto>>()
                .WithName("HAProxyServerStatusGetAll");
        }
            ...
            CancellationToken token)
        {
            ...
            try
            {
                var service = await HaProxyServerStatusService.CreateAsync(dbContext, user, log,
