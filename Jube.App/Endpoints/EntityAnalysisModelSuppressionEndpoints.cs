...
{
    public static class EntityAnalysisModelSuppressionEndpoints
    {
        private const string Base = "/api/EntityAnalysisModelSuppression";

        public static void MapEntityAnalysisModelSuppressionEndpoints(this IEndpointRouteBuilder endpoints)
        {
            var group = endpoints.MapGroup(Base)
                .RequireAuthorization()
                .WithTags("EntityAnalysisModelSuppression");

            group.MapGet("", GetAsync)
                .Produces<List<EntityAnalysisModelSuppressionDto>>()
                .WithName("EntityAnalysisModelSuppressionGetAll");

            group.MapGet("ByEntityAnalysisModelId/{entityAnalysisModelId:int}", GetByEntityAnalysisModelIdAsync)
                .Produces<List<EntityAnalysisModelSuppressionDto>>()
                .WithName("EntityAnalysisModelSuppressionGetByEntityAnalysisModelId");

            group.MapGet("{id:int}", GetByIdAsync)
                .Produces<EntityAnalysisModelSuppressionDto>()
                .WithName("EntityAnalysisModelSuppressionGetById");

            group.MapPost("", CreateAsync)
                .Produces((int)HttpStatusCode.OK)
                .Produces<ValidationResult>((int)HttpStatusCode.BadRequest)
                .WithName("EntityAnalysisModelSuppressionCreate");

            group.MapPut("", UpdateAsync)
                .Produces((int)HttpStatusCode.OK)
                .Produces<ValidationResult>((int)HttpStatusCode.BadRequest)
                .Produces((int)HttpStatusCode.NoContent)
                .WithName("EntityAnalysisModelSuppressionUpdate");

            group.MapPut("DeleteExpiryDate", UpdateDeleteExpiryDateAsync)
                .Produces<EntityAnalysisModelSuppressionDto>()
                .Produces<ValidationResult>((int)HttpStatusCode.BadRequest)
                .Produces((int)HttpStatusCode.NoContent)
                .WithName("EntityAnalysisModelSuppressionUpdateDeleteExpiryDate");

            group.MapDelete("{id:int}", DeleteAsync)
                .Produces((int)HttpStatusCode.OK)
                .Produces((int)HttpStatusCode.NoContent)
                .WithName("EntityAnalysisModelSuppressionDelete");
        }
            ...
            CancellationToken token)
        {
            ...
            try
            {
                var service = await EntityAnalysisModelSuppressionService.CreateAsync(dbContext, user, log,
        ...
        private static async Task<IResult> CreateAsync(
            [FromBody] EntityAnalysisModelSuppressionDto model, HttpContext httpContext, ILog log,
