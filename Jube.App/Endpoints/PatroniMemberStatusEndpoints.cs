...
{
    public static class PatroniMemberStatusEndpoints
    {
        private const string Base = "/api/PatroniMemberStatus";

        public static void MapPatroniMemberStatusEndpoints(this IEndpointRouteBuilder endpoints)
        {
            var group = endpoints.MapGroup(Base)
                .RequireAuthorization()
                .WithTags("PatroniMemberStatus");

            group.MapGet("", GetAsync)
                .Produces<PayloadResult<PatroniMemberStatusDto>>()
                .WithName("PatroniMemberStatusGetAll");
        }
            ...
            CancellationToken token)
        {
            ...
            try
            {
                var service = await PatroniMemberStatusService.CreateAsync(dbContext, user, log,
