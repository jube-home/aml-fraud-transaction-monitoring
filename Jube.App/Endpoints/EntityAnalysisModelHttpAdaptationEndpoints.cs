...
{
    public static class EntityAnalysisModelHttpAdaptationEndpoints
    {
        private const string Base = "/api/EntityAnalysisModelAdaptation";

        public static void MapEntityAnalysisModelHttpAdaptationEndpoints(this IEndpointRouteBuilder endpoints)
        {
            var group = endpoints.MapGroup(Base)
                .RequireAuthorization()
                .WithTags("EntityAnalysisModelHttpAdaptation");

            group.MapGet("", GetAsync)
                .Produces<List<EntityAnalysisModelHttpAdaptationDto>>()
                .WithName("EntityAnalysisModelHttpAdaptationGetAll");

            group.MapGet("ByEntityAnalysisModelId/{entityAnalysisModelId:int}", GetByEntityAnalysisModelIdAsync)
                .Produces<List<EntityAnalysisModelHttpAdaptationDto>>()
                .WithName("EntityAnalysisModelHttpAdaptationGetByEntityAnalysisModelId");

            group.MapGet("{id:int}", GetByIdAsync)
                .Produces<EntityAnalysisModelHttpAdaptationDto>()
                .WithName("EntityAnalysisModelHttpAdaptationGetById");

            group.MapPost("", CreateAsync)
                .Produces((int)HttpStatusCode.OK)
                .Produces<ValidationResult>((int)HttpStatusCode.BadRequest)
                .WithName("EntityAnalysisModelHttpAdaptationCreate");

            group.MapPut("", UpdateAsync)
                .Produces((int)HttpStatusCode.OK)
                .Produces<ValidationResult>((int)HttpStatusCode.BadRequest)
                .Produces((int)HttpStatusCode.NoContent)
                .WithName("EntityAnalysisModelHttpAdaptationUpdate");

            group.MapDelete("{id:int}", DeleteAsync)
                .Produces((int)HttpStatusCode.OK)
                .Produces((int)HttpStatusCode.NoContent)
                .WithName("EntityAnalysisModelHttpAdaptationDelete");
        }
            ...
            CancellationToken token)
        {
            ...
            try
            {
                var service = await EntityAnalysisModelHttpAdaptationService.CreateAsync(dbContext, user, log,
        ...
        private static async Task<IResult> CreateAsync(
            [FromBody] EntityAnalysisModelHttpAdaptationDto model, HttpContext httpContext, ILog log,
