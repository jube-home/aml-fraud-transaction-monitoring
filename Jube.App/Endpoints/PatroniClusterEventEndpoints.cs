...
{
    public static class PatroniClusterEventEndpoints
    {
        private const string Base = "/api/PatroniClusterEvent";

        public static void MapPatroniClusterEventEndpoints(this IEndpointRouteBuilder endpoints)
        {
            var group = endpoints.MapGroup(Base)
                .RequireAuthorization()
                .WithTags("PatroniClusterEvent");

            group.MapGet("", GetAsync)
                .Produces<PayloadResult<PatroniClusterEventDto>>()
                .WithName("PatroniClusterEventGetAll");
        }
            ...
            CancellationToken token)
        {
            ...
            try
            {
                var service = await PatroniClusterEventService.CreateAsync(dbContext, user, log,
