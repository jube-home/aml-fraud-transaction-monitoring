...
{
    public static class CaseWorkflowActionEndpoints
    {
        private const string Base = "/api/CaseWorkflowAction";

        public static void MapCaseWorkflowActionEndpoints(this IEndpointRouteBuilder endpoints)
        {
            var group = endpoints.MapGroup(Base)
                .RequireAuthorization()
                .WithTags("CaseWorkflowAction");

            group.MapGet("", GetAsync)
                .Produces<List<CaseWorkflowActionDto>>()
                .WithName("CaseWorkflowActionList");

            group.MapGet("ByCasesWorkflowIdActiveOnly/{id:int}", GetByCasesWorkflowIdActiveOnlyAsync)
                .Produces<List<CaseWorkflowActionDto>>()
                .WithName("CaseWorkflowActionListByWorkflowIdActiveOnly");

            group.MapGet("ByCasesWorkflowGuidActiveOnly/{guid:guid}", GetByCasesWorkflowGuidActiveOnlyAsync)
                .Produces<List<CaseWorkflowActionDto>>()
                .WithName("CaseWorkflowActionListByWorkflowGuidActiveOnly");

            group.MapGet("ByCasesWorkflowId/{casesWorkflowId:int}", GetByCaseWorkflowIdAsync)
                .Produces<List<CaseWorkflowActionDto>>()
                .WithName("CaseWorkflowActionListByWorkflow");

            group.MapGet("{id:int}", GetByIdAsync)
                .Produces<CaseWorkflowActionDto>()
                .WithName("CaseWorkflowActionGetById");

            group.MapPost("", InsertAsync)
                .Produces<CaseWorkflowActionDto>()
                .Produces<ValidationResult>((int)HttpStatusCode.BadRequest)
                .WithName("CaseWorkflowActionCreate");

            group.MapPut("", UpdateAsync)
                .Produces<CaseWorkflowActionDto>()
                .Produces<ValidationResult>((int)HttpStatusCode.BadRequest)
                .Produces((int)HttpStatusCode.NoContent)
                .WithName("CaseWorkflowActionUpdate");

            group.MapDelete("{id:int}", DeleteAsync)
                .Produces((int)HttpStatusCode.OK)
                .Produces((int)HttpStatusCode.NoContent)
                .WithName("CaseWorkflowActionDelete");
        }
            ...
            IServiceChangeBus serviceChangeBus, CancellationToken token)
        {
            ...
            try
            {
                var service = await CaseWorkflowActionService.CreateAsync(dbContext, user, log,
        ...
        private static async Task<IResult> InsertAsync([FromBody] CaseWorkflowActionDto model,
        ...
        private static async Task<IResult> UpdateAsync([FromBody] CaseWorkflowActionDto model,
            HttpContext httpContext, ILog log, DynamicEnvironment.DynamicEnvironment dynamicEnvironment,
            IStringLocalizerFactory stringLocalizerFactory, IServiceChangeBus serviceChangeBus,
            CancellationToken token)
        {
