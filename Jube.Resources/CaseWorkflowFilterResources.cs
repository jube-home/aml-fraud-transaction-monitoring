...
{
    public sealed class CaseWorkflowFilterResources
    {
        ...
        public const string FieldMaxLength = nameof(FieldMaxLength);
        public const string JsonInvalid = nameof(JsonInvalid);
        public const string SelectJsonRequired = nameof(SelectJsonRequired);
