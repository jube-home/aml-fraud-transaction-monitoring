...
{
    public sealed class EntityAnalysisModelInvocationContextResources
    {
        ...
        public const string RequestJsonInvalid = nameof(RequestJsonInvalid);
        public const string RequestJsonTooLarge = nameof(RequestJsonTooLarge);
    }
}