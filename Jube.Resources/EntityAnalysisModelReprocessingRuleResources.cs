...
{
    public sealed class EntityAnalysisModelReprocessingRuleResources
    {
        ...
        public const string ReprocessingValueRange = nameof(ReprocessingValueRange);
        public const string ReprocessingIntervalInvalid = nameof(ReprocessingIntervalInvalid);
    }
}
