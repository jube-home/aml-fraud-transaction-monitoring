...
{
    public sealed class EntityAnalysisModelActivationRuleSuppressionResources
    {
        ...
        public const string EntityAnalysisModelActivationRuleNameRequired =
            nameof(EntityAnalysisModelActivationRuleNameRequired);

        public const string EntityAnalysisModelActivationRuleNameMaxLength =
            nameof(EntityAnalysisModelActivationRuleNameMaxLength);

        public const string EntityAnalysisModelActivationRuleNameNotFound =
            nameof(EntityAnalysisModelActivationRuleNameNotFound);
