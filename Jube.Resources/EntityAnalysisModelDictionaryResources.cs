...
{
    public sealed class EntityAnalysisModelDictionaryResources
    {
        public const string PermissionDenied = nameof(PermissionDenied);
        public const string NotAuthenticated = nameof(NotAuthenticated);
        public const string EntityAnalysisModelGuidInvalid = nameof(EntityAnalysisModelGuidInvalid);
        ...
        public const string DataNameRequired = nameof(DataNameRequired);
        public const string DataNameMaxLength = nameof(DataNameMaxLength);
    }
}