...
{
    public sealed class VisualisationRegistryResources
    {
        ...
        public const string ColumnsInvalid = nameof(ColumnsInvalid);
        public const string ColumnWidthInvalid = nameof(ColumnWidthInvalid);
        public const string RowHeightInvalid = nameof(RowHeightInvalid);
    }
}