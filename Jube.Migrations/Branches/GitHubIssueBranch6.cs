...
public class GitHubIssueBranch6 : Migration
{
    public override void Up()
    {
        ...
        CreatePermissionAndSubscribeToDefaultAdministrator();
    ...
    private void CreatePermissionAndSubscribeToDefaultAdministrator()
    {
    ...
    private void CreateRoleRegistryPermission()
    {
        ...
        Create.Table("RoleRegistryPermissionVersion")
            .WithColumn("Id").AsInt32().PrimaryKey().Identity()
            .WithColumn("RoleRegistryPermissionVersionId").AsInt32().Nullable()
            .WithColumn("Guid").AsGuid().Nullable()
        ...
        Create.ForeignKey().FromTable("RoleRegistryPermissionVersion").ForeignColumn("RoleRegistryPermissionVersionId")
    ...
    private void CreateUserRegistry()
    {
        ...
        Create.Table("UserRegistryVersion")
            .WithColumn("Id").AsInt32().PrimaryKey().Identity()
            .WithColumn("UserRegistryVersionId").AsInt32().Nullable()
            .WithColumn("Guid").AsGuid().Nullable()
            .WithColumn("RoleRegistryId").AsInt32().Nullable()
        ...
        Create.ForeignKey().FromTable("UserRegistryVersion").ForeignColumn("UserRegistryVersionId")
