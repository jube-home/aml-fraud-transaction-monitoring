...
{
    public static class RedisConnectionEventCapture
    {
        private const int MaxQueueLength = 20000;

        private static readonly ConcurrentQueue<RedisConnectionEventCaptureRecord> queue = new();
        ...
        public static void Enqueue(RedisConnectionEventCaptureRecord record)
        {
        ...
        public static List<RedisConnectionEventCaptureRecord> DrainAll()
        {
            var drained = new List<RedisConnectionEventCaptureRecord>();
