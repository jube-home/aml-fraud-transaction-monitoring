...
{
    public class EntityAnalysisModelStagePerformanceCounterRepository
    {
        private readonly DbContext dbContext;
        private readonly int? tenantRegistryId;

        public EntityAnalysisModelStagePerformanceCounterRepository(DbContext dbContext, string userName)
        {
        ...
        public EntityAnalysisModelStagePerformanceCounterRepository(DbContext dbContext)
        {
            this.dbContext = dbContext;
        }

        public async Task<EntityAnalysisModelStagePerformanceCounter> InsertAsync(
            EntityAnalysisModelStagePerformanceCounter model,
        ...
        private IQueryable<EntityAnalysisModelStagePerformanceCounter> BuildFilteredQuery(
            bool includeAllTenants, DateTime? from, DateTime? to, int? stageId, double? samplePercentage)
        {
            var query = dbContext.EntityAnalysisModelStagePerformanceCounter
        ...
        private static IOrderedQueryable<EntityAnalysisModelStagePerformanceCounter> ApplySort(
            IQueryable<EntityAnalysisModelStagePerformanceCounter> query, string sortField, string sortDirection)
        {
        ...
        public async Task<IEnumerable<EntityAnalysisModelStagePerformanceCounterRow>> GetLastAsync(
            ...
            double? samplePercentage, string sortField, string sortDirection, CancellationToken token = default)
        {
            ...
            return await ApplySort(query, sortField, sortDirection)
                .Take(take)
                .Select(s => new EntityAnalysisModelStagePerformanceCounterRow(
