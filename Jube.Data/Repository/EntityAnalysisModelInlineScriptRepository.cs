...
public class EntityAnalysisModelInlineScriptRepository
{
    ...
    public IEnumerable<EntityAnalysisModelInlineScript> GetByEntityAnalysisModelIdOrderById(int entityAnalysisModelId)
    {
        return _dbContext.EntityAnalysisModelInlineScript
            .Where(w => (w.EntityAnalysisModel.TenantRegistryId == _tenantRegistryId || !_tenantRegistryId.HasValue)
    ...
    {
        _dbContext.EntityAnalysisModelInlineScript
            .Where(d =>
                (d.EntityAnalysisModel.TenantRegistryId == _tenantRegistryId || !_tenantRegistryId.HasValue)
