...
namespace Jube.Data.Repository
{
    ...
    public class VisualisationRegistryRoleRepository
    {
        private readonly DbContext dbContext;
        private readonly int tenantRegistryId;
        private readonly string userName;

        public VisualisationRegistryRoleRepository(DbContext dbContext, string userName)
        {
        ...
        public VisualisationRegistryRoleRepository(DbContext dbContext, int tenantRegistryId)
        {
            this.dbContext = dbContext;
        ...
        {
            var records = await dbContext.VisualisationRegistryRole
