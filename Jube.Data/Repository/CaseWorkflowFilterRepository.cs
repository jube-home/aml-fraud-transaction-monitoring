...
namespace Jube.Data.Repository
{
    ...
    public class CaseWorkflowFilterRepository
    {
        ...
        public Task<CaseWorkflowFilter> GetByNameCaseWorkflowIdAsync(string name, int caseWorkflowId,
        ...
        public async Task<IEnumerable<CaseWorkflowFilter>> GetByCasesWorkflowIdOrderByIdAsync(int casesWorkflowId,
            CancellationToken token = default)
        {
            return await dbContext.CaseWorkflowFilter
                .Where(w => w.CaseWorkflow.EntityAnalysisModel.TenantRegistryId == tenantRegistryId
        ...
        public async Task<IEnumerable<CaseWorkflowFilter>> GetByCasesWorkflowIdActiveOnlyAsync(int casesWorkflowId,
            CancellationToken token = default)
        {
            return await dbContext.CaseWorkflowFilter
                .Where(w => w.CaseWorkflow.EntityAnalysisModel.TenantRegistryId == tenantRegistryId
        ...
        public async Task<IEnumerable<CaseWorkflowFilter>> GetByCasesWorkflowGuidActiveOnlyAsync(Guid caseWorkflowGuid,
            CancellationToken token = default)
        {
            return await dbContext.CaseWorkflowFilter
                .Where(w => w.CaseWorkflow.EntityAnalysisModel.TenantRegistryId == tenantRegistryId
        ...
        public async Task<CaseWorkflowFilter> UpdateAsync(CaseWorkflowFilter model, CancellationToken token = default)
        {
            ...
            var audit = new CaseWorkflowFilterVersion
            {
                CaseWorkflowFilterId = existing.Id,
                CaseWorkflowId = existing.CaseWorkflowId,
                Name = existing.Name,
                FilterJson = existing.FilterJson,
                FilterSql = existing.FilterSql,
                SelectJson = existing.SelectJson,
                FilterTokens = existing.FilterTokens,
