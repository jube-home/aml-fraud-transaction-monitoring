...
namespace Jube.Data.Repository
{
    ...
    public class EntityAnalysisModelRoleRepository
    {
        private readonly DbContext dbContext;
        private readonly int tenantRegistryId;
        private readonly string userName;

        public EntityAnalysisModelRoleRepository(DbContext dbContext, string userName)
        {
        ...
        public EntityAnalysisModelRoleRepository(DbContext dbContext, int tenantRegistryId)
        {
            this.dbContext = dbContext;
        ...
        {
            var records = await dbContext.EntityAnalysisModelRole
