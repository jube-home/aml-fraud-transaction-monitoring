...
namespace Jube.Data.Repository
{
    ...
    public class VisualisationRegistryDatasourceRoleRepository
    {
        ...
        public async Task<IEnumerable<VisualisationRegistryDatasourceRole>> GetAllDescAsync(
        ...
        public Task<List<VisualisationRegistryDatasourceRole>> GetByVisualisationRegistryDatasourceGuidAsync(
            Guid visualisationRegistryDatasourceGuid, CancellationToken token = default)
        {
        ...
        public Task<bool> ExistsVisualisationRegistryDatasourceAsync(Guid visualisationRegistryDatasourceGuid,
            CancellationToken token = default)
        {
            return dbContext.VisualisationRegistryDatasource.AnyAsync(w =>
                w.Guid == visualisationRegistryDatasourceGuid
        ...
        public async Task<VisualisationRegistryDatasourceRole> InsertAsync(VisualisationRegistryDatasourceRole model,
            CancellationToken token = default)
        {
            var existing = await dbContext.VisualisationRegistryDatasourceRole.FirstOrDefaultAsync(w =>
                w.VisualisationRegistryDatasourceGuid == model.VisualisationRegistryDatasourceGuid &&
            ...
            {
                var raced = await dbContext.VisualisationRegistryDatasourceRole.FirstOrDefaultAsync(w =>
                    w.VisualisationRegistryDatasourceGuid == model.VisualisationRegistryDatasourceGuid &&
                    w.RoleRegistryGuid == model.RoleRegistryGuid
                    && (w.Deleted == 0 || w.Deleted == null), token);
                if (raced == null)
            ...
            CancellationToken token = default)
        {
            return dbContext.VisualisationRegistryDatasourceRole
                .Where(d =>
                    d.VisualisationRegistryDatasource.VisualisationRegistry.TenantRegistryId ==
