...
public class ExportPeekRepository
{
    private readonly DbContext _dbContext;
    private readonly int _tenantRegistryId;
    private readonly string _userName;

    public ExportPeekRepository(DbContext dbContext, string userName)
    {
    ...
    public ExportPeek Insert(ExportPeek model)
    {
    ...
    public ExportPeek Update(ExportPeek model)
    {
